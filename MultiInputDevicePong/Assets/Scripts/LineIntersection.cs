...
public struct Line
{
    ...
    public Line(double x1_, double y1_, double x2_, double y2_)
    {
        x1 = x1_;
        y1 = y1_;
        x2 = x2_;
...
public class LineIntersection
{
    ...
    public static Point FindIntersection(Line lineA, Line lineB, bool finite_line_length = true, double tolerance = 0.001)
    {
        ...
        if (!finite_line_length
            || 
                (finite_line_length &&
                IsInsideLine(lineA, x, y) &&
